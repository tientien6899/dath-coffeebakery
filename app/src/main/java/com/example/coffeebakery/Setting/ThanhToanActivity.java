...
public class ThanhToanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mData.child("ChinhSach").child("Chính sách thanh toán").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    private void AnhXa() {
        back = findViewById(R.id.img_Backthanhtoan);
        noidung = findViewById(R.id.thanhtoan_noidung);
    }
}