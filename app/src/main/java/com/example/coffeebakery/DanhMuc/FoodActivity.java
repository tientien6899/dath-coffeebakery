...
public class FoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mData.child("Thức ăn").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new ProductAdapter(productArrayList,FoodActivity.this);
                LinearLayoutManager linearLayoutManager1 = new LinearLayoutManager(FoodActivity.this);
    ...
    private void AnhXa() {
        danhsach = findViewById(R.id.rcv_danhsachfood);
        timkiem = findViewById(R.id.searchViewFood);
    }
    ...
    private void search(String s){
        ...
        ProductAdapter adapter1 = new ProductAdapter(list,FoodActivity.this);
