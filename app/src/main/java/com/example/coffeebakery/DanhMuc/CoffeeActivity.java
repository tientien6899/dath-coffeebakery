...
public class CoffeeActivity extends AppCompatActivity {
    ...
    private void AnhXa() {
        danhsach = findViewById(R.id.rcv_danhsachcaphe);
        timkiem = findViewById(R.id.searchViewCoffee);
    }
    ...
    private void search(String s){
        ...
        ProductAdapter adapter1 = new ProductAdapter(list,CoffeeActivity.this);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(CoffeeActivity.this);
