...
public class JuiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mData.child("Nước ép - Sinh tố").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new ProductAdapter(productArrayList,JuiceActivity.this);
                LinearLayoutManager linearLayoutManager1 = new LinearLayoutManager(JuiceActivity.this);
    ...
    private void AnhXa() {
        danhsach = findViewById(R.id.rcv_danhsachjuice);
        timkiem = findViewById(R.id.searchViewJuice);
    }
    ...
    private void search(String s){
        ...
        ProductAdapter adapter1 = new ProductAdapter(list,JuiceActivity.this);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(JuiceActivity.this);
